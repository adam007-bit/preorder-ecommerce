...
{ id: "beauty_gluthion_600mg", name: "GLUTHION INJ - 600MG (10VIAL)", category: "beauty", description: "Gluthion injection 600mg per vial, 10 vials per box.", variations: [{ size: "600mg", type: "10 Vial", price: 160 }], stock: 100 },
{ id: "beauty_glutaone_1200mg", name: "GLUTAONE INJ - 1200MG (10VIAL)", category: "beauty", description: "Glutaone injection 1200mg per vial, 10 vials per box.", variations: [{ size: "1200mg", type: "10 Vial", price: 190 }], stock: 100 },
{ id: "beauty_chiotocin_25mg", name: "CHIOTOCIN INJ - 25MG (10VIAL)", category: "beauty", description: "Chiotocin injection 25mg per vial, 10 vials per box.", variations: [{ size: "25mg", type: "10 Vial", price: 100 }], stock: 100 },
{ id: "beauty_lipotocin_600mg", name: "LIPOTOCIN INJ - 600MG (10VIAL)", category: "beauty", description: "Lipotocin injection 600mg per vial, 10 vials per box.", variations: [{ size: "600mg", type: "10 Vial", price: 160 }], stock: 100 },
{ id: "beauty_luthione_600mg", name: "LUTHIONE - 600MG (10VIAL)", category: "beauty", description: "Luthione 600mg per vial, 10 vials per box.", variations: [{ size: "600mg", type: "10 Vial", price: 150 }], stock: 100 },
{ id: "beauty_luthione_1200mg", name: "LUTHIONE - 1200MG (10VIAL)", category: "beauty", description: "Luthione 1200mg per vial, 10 vials per box.", variations: [{ size: "1200mg", type: "10 Vial", price: 190 }], stock: 100 },
{ id: "beauty_cinderella_inj", name: "CINDELLA INJ (10VIAL)", category: "beauty", description: "Cinderella injection, 10 vials per box.", variations: [{ size: "10ml", type: "10 Vial", price: 120 }], stock: 100 },
{ id: "beauty_vitamin_c_inj", name: "VITAMIN C INJ (10VIAL)", category: "beauty", description: "Vitamin C injection, 10 vials per box.", variations: [{ size: "10ml", type: "10 Vial", price: 130 }], stock: 100 },
{ id: "beauty_profhilo", name: "PROFHILO (1 SYRINGE)", category: "beauty", description: "Profhilo 1 syringe.", variations: [{ size: "1 syringe", type: "1 Syringe", price: 350 }], stock: 100 },
{ id: "beauty_sculptra", name: "SCULPTRA (1 VIAL)", category: "beauty", description: "Sculptra 1 vial.", variations: [{ size: "1 vial", type: "1 Vial", price: 700 }], stock: 100 },
{ id: "beauty_juvederm_skinvive", name: "JUVEDERM SKINVIVE (2 SYRINGES)", category: "beauty", description: "Juvederm SkinVive 2 syringes.", variations: [{ size: "2 syringes", type: "2 Syringes", price: 500 }], stock: 100 },
{ id: "beauty_juvederm_voluma", name: "JUVEDERM VOLUMA (2 SYRINGES)", category: "beauty", description: "Juvederm Voluma 2 syringes.", variations: [{ size: "2 syringes", type: "2 Syringes", price: 700 }], stock: 100 },
{ id: "beauty_juvederm_volift", name: "JUVEDERM VOLIFT (2 SYRINGES)", category: "beauty", description: "Juvederm Volift 2 syringes.", variations: [{ size: "2 syringes", type: "2 Syringes", price: 700 }], stock: 100 },
{ id: "beauty_juvederm_volbella", name: "JUVEDERM VOLBELLA (2 SYRINGES)", category: "beauty", description: "Juvederm Volbella 2 syringes.", variations: [{ size: "2 syringes", type: "2 Syringes", price: 700 }], stock: 100 },
{ id: "beauty_juvederm_volux", name: "JUVEDERM VOLUX (2 SYRINGES)", category: "beauty", description: "Juvederm Volux 2 syringes.", variations: [{ size: "2 syringes", type: "2 Syringes", price: 700 }], stock: 100 },
{ id: "beauty_lemon_bottle_5vial", name: "LEMON BOTTLE (5 VIAL)", category: "beauty", description: "Lemon Bottle 5 vials per box.", variations: [{ size: "5 vials", type: "5 Vial", price: 250 }], stock: 100 },
