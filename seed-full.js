...
const oralPeptidesData = [
  { id: "oral_5amino_1mq", name: "5-Amino-1MQ", category: "oral", description: "Supports metabolism, helps increase calorie burning, and may assist with fat loss.", variations: [{ size: "50mg", type: "60 Capsules", price: 230 }], stock: 100 },
  { id: "oral_bpc157", name: "BPC-157", category: "oral", description: "Supports recovery, tissue repair, gut health, and injury healing.", variations: [{ size: "500mcg", type: "100 Capsules", price: 180 }], stock: 100 },
  { id: "oral_tesofensine", name: "Tesofensine", category: "oral", description: "Helps reduce appetite, control cravings, and support weight loss.", variations: [{ size: "500mcg", type: "60 Capsules", price: 160 }], stock: 100 },
  { id: "oral_dihexa", name: "Dihexa", category: "oral", description: "Supports memory, focus, learning, and cognitive performance.", variations: [{ size: "10mg", type: "60 Capsules", price: 150 }], stock: 120 },
  { id: "oral_bam15", name: "BAM15", category: "oral", description: "May increase energy expenditure and support fat loss without stimulants.", variations: [{ size: "50mg", type: "60 Capsules", price: 470 }], stock: 120 },
  { id: "oral_orforglipron", name: "Orforglipron", category: "oral", description: "Helps reduce appetite, improve blood sugar control, and support weight management.", variations: [{ size: "6mg", type: "90 Capsules", price: 500 }], stock: 100 },
  { id: "oral_slupp332", name: "SLU-PP-332", category: "oral", description: "Designed to enhance endurance, increase energy utilization, and support fat burning.", variations: [{ size: "250mcg", type: "100 Capsules", price: 90 }], stock: 100 },
  { id: "oral_kpv", name: "KPV", category: "oral", description: "Used to calm inflammation in the gut, skin, and throughout the body.", variations: [{ size: "300mcg", type: "60 Capsules", price: 120 }], stock: 100 }
];

// ==================== PRODUK TAMBAHAN (solvent, beauty, peptides) ====================
const additionalProducts = [
  // SOLVENT
  { id: "solvent_bac_water", name: "Bac Water", category: "solvent", description: "Bacteriostatic water for reconstitution.", variations: [{ size: "3ml", type: "Vial", price: 24 }, { size: "10ml", type: "Vial", price: 25 }], stock: 100 },
  { id: "solvent_usb_bac_water", name: "USP Bac Water", category: "solvent", description: "Bacteriostatic water for reconstitution.", variations: [{ size: "10ml", type: "Vial", price: 32 }], stock: 100 },
  { id: "solvent_steriled_water", name: "Sterilized Water", category: "solvent", description: "Sterile water for injection.", variations: [{ size: "10ml", type: "Vial", price: 25 }], stock: 100 },
  { id: "solvent_acetic_acid", name: "Acetic Acid", category: "solvent", description: "For peptide reconstitution.", variations: [{ size: "10ml", type: "Vial", price: 25 }], stock: 100 },

  // BEAUTY PEPTIDES
  { id: "beauty_ghk_cu", name: "GHK-Cu", category: "beauty", description: "Copper peptide for hair and skin (injectable).", variations: [{ size: "50mg", type: "Vial", price: 32 }, { size: "100mg", type: "Vial", price: 35 }], stock: 100 },
  { id: "beauty_ahk_cu", name: "AHK-CU", category: "beauty", description: "Copper peptide for hair growth.", variations: [{ size: "50mg", type: "Vial", price: 40 }, { size: "100mg", type: "Vial", price: 55 }], stock: 100 },
  { id: "beauty_glutathione", name: "Glutathione (Fuan)", category: "beauty", description: "Antioxidant for skin brightening.", variations: [{ size: "600mg", type: "Vial", price: 35 }, { size: "1500mg", type: "Vial", price: 55 }], stock: 100 },
  { id: "beauty_glow", name: "Glow", category: "beauty", description: "Skin brightening and anti-aging.", variations: [{ size: "70mg", type: "Vial", price: 90 }], stock: 100 },
  { id: "beauty_klow", name: "Klow", category: "beauty", description: "Brightening and anti-aging peptide complex.", variations: [{ size: "80mg", type: "Vial", price: 100 }], stock: 100 },
  { id: "beauty_snap8", name: "Snap-8", category: "beauty", description: "Anti-aging peptide.", variations: [{ size: "10mg", type: "Vial", price: 40 }], stock: 100 },
  { id: "beauty_matrixyl", name: "Matrixyl", category: "beauty", description: "Anti-wrinkle peptide.", variations: [{ size: "10mg", type: "Vial", price: 45 }], stock: 100 },
  { id: "beauty_matrixyl3000", name: "Matrixyl 3000", category: "beauty", description: "Advanced anti-aging peptide.", variations: [{ size: "10mg", type: "Vial", price: 140 }], stock: 100 },
  { id: "beauty_ggh", name: "GGH", category: "beauty", description: "Growth hormone releasing peptide for skin.", variations: [{ size: "10ml", type: "Vial", price: 90 }], stock: 100 },
  { id: "beauty_exosome", name: "Exosome", category: "beauty", description: "Exosome for cellular regeneration.", variations: [{ size: "100mg", type: "Vial", price: 65 }], stock: 100 },
  { id: "beauty_pdrn", name: "PDRN", category: "beauty", description: "Polydeoxyribonucleotide for tissue repair.", variations: [{ size: "5ml", type: "Vial", price: 45 }], stock: 100 },
  { id: "beauty_botulinum_toxin", name: "Botulinum Toxin", category: "beauty", description: "Neurotoxin for cosmetic use.", variations: [{ size: "100iu", type: "Vial", price: 60 }], stock: 100 },
  { id: "beauty_super_beauty", name: "Super Beauty (HHB)", category: "beauty", description: "Skin brightening and anti-aging.", variations: [{ size: "10ml", type: "Vial", price: 55 }], stock: 100 },
  { id: "beauty_hyaluronic_acid", name: "Hyaluronic Acid", category: "beauty", description: "Moisture retention.", variations: [{ size: "5mg", type: "Vial", price: 15 }], stock: 120 },
  { id: "beauty_pink_hyaluronic", name: "Pink Hyaluronic Acid", category: "beauty", description: "Hyaluronic acid formulation.", variations: [{ size: "5ml", type: "Vial", price: 45 }], stock: 100 },
  { id: "beauty_whitening_spot", name: "Whitening & Spot Fading", category: "beauty", description: "Skin lightening complex.", variations: [{ size: "5ml", type: "Vial", price: 50 }], stock: 100 },
  { id: "beauty_snake_venom", name: "Snake Venom", category: "beauty", description: "Synthetic peptide for anti-wrinkle.", variations: [{ size: "5ml", type: "Vial", price: 30 }], stock: 100 },
  { id: "beauty_pe_22_28", name: "PE 22 28", category: "beauty", description: "Anti-aging peptide.", variations: [{ size: "5mg", type: "Vial", price: 45 }, { size: "10mg", type: "Vial", price: 60 }], stock: 100 },
  { id: "beauty_pigment_serum", name: "Pigment Serum", category: "beauty", description: "Brightening and spot fading serum.", variations: [{ size: "10ml", type: "Serum", price: 30 }], stock: 100 },
  { id: "beauty_oligo_peptide24", name: "Oligo Peptide 24", category: "beauty", description: "Anti-aging peptide complex.", variations: [{ size: "10mg", type: "Peptide", price: 35 }], stock: 100 },
  { id: "beauty_vitamin_c_tablet", name: "Vitamin C Tablet With Essense", category: "beauty", description: "Vitamin C brightening tablets with essence.", variations: [{ size: "10pcs", type: "Tablet", price: 40 }], stock: 100 },
  { id: "beauty_acne_serum", name: "Acne Serum", category: "beauty", description: "Anti-acne and soothing serum.", variations: [{ size: "5ml", type: "Serum", price: 30 }], stock: 100 },
  { id: "beauty_hydro_glow", name: "Hydro Glow Serum", category: "beauty", description: "Hydrating and brightening serum.", variations: [{ size: "5ml", type: "Serum", price: 30 }], stock: 100 },
  { id: "beauty_ghkcu_serum", name: "GHK-Cu Serum", category: "beauty", description: "Copper peptide serum for anti-aging.", variations: [{ size: "5ml", type: "Serum", price: 30 }], stock: 100 },
  { id: "beauty_ghkcu_topical", name: "GHK-Cu Topical", category: "beauty", description: "Copper peptide topical.", variations: [{ size: "1000mg", type: "Vial", price: 60 }], stock: 100 },
  { id: "beauty_fiona_masker", name: "Fiona Masker", category: "beauty", description: "Facial mask.", variations: [{ size: "10mg", type: "Set", price: 35 }], stock: 100 },

  // PEPTIDES (injectable & fat loss) – HANYA VIAL, TIADA KIT
  { id: "peptide_retatrutide", name: "Retatrutide", category: "peptides", description: "Triple agonist for weight management.", variations: [{ size: "5mg", type: "Vial", price: 40 }, { size: "10mg", type: "Vial", price: 45 }, { size: "15mg", type: "Vial", price: 60 }, { size: "20mg", type: "Vial", price: 65 }, { size: "30mg", type: "Vial", price: 90 }, { size: "40mg", type: "Vial", price: 90 }], stock: 100 },
  { id: "peptide_reta_cagri", name: "Reta Cagri", category: "peptides", description: "Retatrutide + Cagrilintide blend.", variations: [{ size: "10mg", type: "Vial", price: 100 }], stock: 100 },
  { id: "peptide_reta_tirze", name: "Reta Tirze", category: "peptides", description: "Retatrutide + Tirzepatide blend.", variations: [{ size: "60mg", type: "Vial", price: 220 }], stock: 100 },
